...
(function ($) {
	...
	Gitea.renderDiffView = function () {
		...
		function prepareToForm() {
			$('.add-comment').hide('fast', function () {
				$(this).remove();
			});
			$('button.answer').hide();
		}
...
function initRepo() {
	...
	// issue create ajax submit
	(function () {
		var $form = $('#issue-new-form');
		var $clickedButton;
		$('button[name="submit"]', $form).on("click", function () {
			$clickedButton = $(this);
		});
	...
	// issue new comment ajax submit
	(function () {
		var $form = $('#issue-add-comment-form');
		var $clickedButton;
		$('button[name="submit"]', $form).on("click", function () {
			$clickedButton = $(this);
		});
